...
<div class="row">
    ...
    <div class="col-lg-2"> 
        <p class="text-right"><a href="{{ Route('books.create') }}" class="btn btn-success">New Book</a></p>
    </div>
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td>
            <form method="post" action="{{ route('books.destroy') }}" onsubmit="return confirm('Are you sure you want to delete?');">
                @csrf
